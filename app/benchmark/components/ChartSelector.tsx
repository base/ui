...
import { deepEqual } from "../utils/collections";
import {
  camelToTitleCase,
  formatValue,
  formatLabel,
...
interface ChartSelectorProps {
  ...
  /** Resolved run id (never "latest") — the target of the "View All Runs" link. */
...
const ChartSelector = ({
  ...
  useEffect(() => {
    ...
    if (!deepEqual(dataToSend, lastSentDataRef.current)) {
