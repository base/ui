...
import { createPublicClient, encodeFunctionData, formatEther, http, isAddress, type Address, type Hex } from 'viem';
...
function Activity({ rows }: { rows: Activity[] }) {
  return (
