    ...
    <div className="flex flex-col gap-1.5">
      <form onSubmit={handleSubmit} className="relative w-full">
        ...
        <input
          ...
          autoComplete="off"
          className={cn(
            'w-full rounded-xl border border-bds-gray-10 bg-bds-gray-0 py-3 pl-9 font-sans text-sm text-black outline-none transition-colors placeholder:text-bds-gray-40 focus:border-black dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder:text-bds-gray-60 dark:focus:border-bds-blue-40',
