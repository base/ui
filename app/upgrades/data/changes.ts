...
export const changes: Change[] = [
  ...
  },
  {
    ...
    upgrade: 'cobalt',
    summary:
      "<p class='pb-4'>Cobalt will bring the following improvements to the B20 token standard:</p><p class='mt-2 pb-4'><strong>Pay transaction fees in B20s:</strong> as part of our rollout of EIP-8130, users will be able to pay transaction fees in B20s.</p><p class='mt-2 pb-4'><strong><a href='https://github.com/base/base-std/blob/main/changelog/02_Cobalt_B20Asset_multiplier.md' target='_blank' rel='noreferrer' class='text-base-blue hover:underline'>Schedule Multiplier Updates:</a></strong> allows issuers to schedule (and optionally cancel) a multiplier to tokens. This allows for onchain representation of splits, without needing to mint or burn tokens. Only available on the Asset variant of B20.</p><p class='mt-2 pb-4'><strong><a href='https://github.com/base/base-std/blob/main/changelog/02_Cobalt_B20_seize.md' target='_blank' rel='noreferrer' class='text-base-blue hover:underline'>Transfer blocked:</a></strong> simplifies the current freeze and seize model by reducing the <code>burnBlocked</code> + <code>mint</code> steps into a new <code>transferFromBlocked</code> action.</p><p class='mt-2'><strong><a href='https://github.com/base/base-std/blob/main/changelog/02_Cobalt_PolicyRegistry_composite_policy.md' target='_blank' rel='noreferrer' class='text-base-blue hover:underline'>New Policies - Union (||) &amp; Intersect (&amp;&amp;):</a></strong> the Union policy allows asset issuers managing many tokens the ability to share policies by default with the ability to enable overrides per token. The Intersect policy allows asset issuers the ability to compose allowlist behaviors with commonly-needed blocklists.</p>",
    migrationNotes:
