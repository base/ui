 ...
 *
 * Ported from base-web (coinbase.ghe.com/protocols/base-web), which is what
 * serves base.org:
 ...
 * constant, `next/link` replaces base-web's analytics Link wrapper, and a
    ...
    try {
      ...
      if (blockyGrids) {
        Array.from(blockyGrids as NodeListOf<Element>).forEach((grid, gridIndex) => {
          ...
          // timelines stay diffable against base-web.
